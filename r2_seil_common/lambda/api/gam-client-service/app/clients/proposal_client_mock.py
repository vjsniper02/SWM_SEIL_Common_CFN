...
PROPOSAL_RESPONSE_ACTION = {"numChanges": 1}
...
class ProposalClientMock(ProposalClient):
    ...
    def getProposalsByStatement(self, get_proposal_request):
        return {"results": [PROPOSAL_SAMPLE]}

    def createProposals(self, create_proposal_request):
        return [PROPOSAL_SAMPLE]

    def updateProposals(self, update_proposal_request):
        return [PROPOSAL_SAMPLE]

    def performProposalAction(self, request, statement):
        return PROPOSAL_RESPONSE_ACTION
